...
let bayan=mapCurrentEvents()
console.log(bayan);
  
  response.status(200).send("bayan");

}

const mapCurrentEvents = () => {
  let arr=[]
  currentEvents.news.forEach(element => {

    let locationData = new Event(element);
...
const countNumberOfElements = (arr) => {
 let count= arr.reduce((accumaltor, value, index)=>{
    accumaltor=accumaltor+1
    return accumaltor;
 }, 0);
 return  count
...
const reversedString = (str) => {
 ...
 let arr3=arr2.join(' ');
 let arr4=arr3.split(" ")
 let arr5=arr4[0].split("")
 let arr51=arr5.reverse();
 let arr6=arr4[1].split("")
 let arr62=arr6.reverse();


 let count1=  arr51.reduce((accumaltor, value, index)=>{
  accumaltor=accumaltor+value
return accumaltor
 
});
let count2=  arr62.reduce((accumaltor, value, index)=>{
  accumaltor=accumaltor+value
  return accumaltor
...
let arr7=arrNew.join(' ');
return arr7
};
// 'Code 301')).toStrictEqual('103 edoC');
/* ------------------------------------------------------------------------------------------------
